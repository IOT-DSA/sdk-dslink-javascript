...
var ECDH = {
  importKey: function(string) {
    if(string.indexOf(' ') !== -1) {
      ...
      var privateKey = new curve.PrivateKey(curve.NamedCurve.P256, new Buffer(string[0], 'base64'));
      var publicKey = curve.Point.fromEncoded(curve.NamedCurve.P256, new Buffer(string[1], 'base64'));
    } else {
      var privateKey = new curve.PrivateKey(curve.NamedCurve.P256, new Buffer(string, 'base64'));
