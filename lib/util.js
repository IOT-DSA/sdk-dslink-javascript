...
var ECDH = {
  importKey: function(string) {
    ...
    if(string.indexOf(' ') !== -1) {
      ...
      privateKey = new curve.PrivateKey(curve.NamedCurve.P256, new Buffer(string[0], 'base64'));
      publicKey = curve.Point.fromEncoded(curve.NamedCurve.P256, new Buffer(string[1], 'base64'));
    } else {
