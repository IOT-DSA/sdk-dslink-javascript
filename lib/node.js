...
Node.prototype.attribute = function(key, value) {
  return _.propFunc(this.__priv__.attributes, key, value);
};

Node.prototype.config = function(key, value) {
  return _.propFunc(this.__priv__.config, key, value);
};
...
function ActionNode(id, opt) {
  ...
  _.prop(this, 'functionName', function() {
    return this.__priv__.config.function;
  }, function(val) {
    this.__priv__.config.function = val;
