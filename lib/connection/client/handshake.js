...
module.exports = function handshake(opt) {
  return new Promise(function(resolve, reject) {
    ...
    var connInfo = opt.connInfo || {};

    connInfo.publicKey = _.Base64.urlSafe(opt.keys.publicKey.getEncoded());
    connInfo.isRequester = opt.requester;
    connInfo.isResponder = opt.responder;
    connInfo.version = _['DSA_VERSION'];

    var connDetails = JSON.stringify(connInfo);
